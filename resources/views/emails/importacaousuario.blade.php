...
<p>O acesso ao sistema pode ser feito em {{asset('/')}}op/{{ $user->poll ? $user->poll->code . " " : " " }} com seu CPF [{{ $user->document }}] e a senha acima. O período de votação está disponível no site da entidade.</p>
