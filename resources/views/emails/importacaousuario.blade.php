...
<p>O acesso ao sistema pode ser feito em http://afisvec.swge.com.br/eleicao/{{ $user->poll ? $user->poll->code . " " : " " }}com seu CPF [{{ $user->document }}] e a senha acima. O período de votação está disponível no site da entidade.</p>
